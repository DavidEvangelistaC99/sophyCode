...
from modFreq import chirpStandard, chirpCentral, chirp_mod, chirp_usrp
import math
import os
import re
import sys
    ...
    def run(self, starttime=None, endtime=None, duration=None, period=1):
        ...
        for k in range(op.nchs):
            ...
            if op.waveform is not None:
                ...
                src_k = blocks.vector_source_c(chirp_usrp(amp_,ipp_,dc_,sr_,fc_,bw_), repeat=True,
                )
            else:
...
#python3 txNew.py -m 192.168.20.7 -d "A:AB" -y "TX/RX" -f 70132500 -r 20000000 -file_chirp chirp_ipp_0.0004_dc_15.0_sr_20000000.0_fc_0.0_bw_4000000.0_amp_1.0.json

#Example Final 3 :D No terminado :(
#Generación con Sample Rate de RX
#python3 tx.py -m 192.168.20.7 -d "A:AB" -y "TX/RX" -f 0 -r 20000000 -file_chirp chirp_ipp_0.0004_dc_15.0_sr_tx_20000000.0_sr_rx_2500000.0_fc_1000000.0_bw_1000000.0_amp_1.0.json
