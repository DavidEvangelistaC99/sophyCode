...
def main(args):
    ...
    if not conf['usrp_tx']['enable_2']: # One Pulse
        ...
        if '1' in args.pulses:
            ...
            # opObj11 = voltage1.addOperation(name='selectChannels')
            # opObj11.addParameter(name='channelList', value='0,1',format='intList')
            # opObj10 = voltage1.addOperation(name='selectChannels')
            # opObj10.addParameter(name='channelList', value=[0,1])
            # opObj10.addParameter(name='channelList', value='0',format='int')
        ...
        if '2' in args.pulses:
            ...
            # opObj10 = voltage2.addOperation(name='selectChannels')
            # opObj10.addParameter(name='channelList', value=[0,1])
            # opObj10.addParameter(name='channelList', value='0',format='int')
