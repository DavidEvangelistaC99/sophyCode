...
#david
experiment = "CHIRP@2025-10-23T15-46-31"
...
numpy.save(PATH + experiment + '/chirp_1.npy', chirp_tx_1)
...
numpy.save(PATH + experiment + '/chirp_2.npy', chirp_tx_2)
    ...
    if not conf['usrp_tx']['enable_2']: # One Pulse
        ...
        if conf['usrp_tx']['code_type_1'] != 'None':
            ...
            if conf['usrp_tx']['code_type_1'] == 'CHIRP':
                ...
                chirp_tx_1, _ = numpy.load("chirp.npy")
        ...
        if '1' in args.pulses:
            ...
            if conf['usrp_tx']['code_type_1'] != 'None':
                ...
                if conf['usrp_tx']['code_type_1'] == 'CHIRP':
                    ...
                    #-------------------CODIGO CHIRP PEQUENO---------------------------
                    chirp_tx_1 = numpy.load(PATH + experiment + '/chirp_1.npy')
        ...
        if '2' in args.pulses:
            ...
            if conf['usrp_tx']['code_type_2']:
                ...
                if conf['usrp_tx']['code_type_2'] == 'CHIRP':
                    ...
                    #-------------------CODIGO CHIRP GRANDE---------------------------
                    chirp_tx_2 = numpy.load(PATH + experiment + '/chirp_2.npy')
