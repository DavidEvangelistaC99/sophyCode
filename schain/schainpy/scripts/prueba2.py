...
def main(args):
    ...
    if '1' in args.pulses:
        ...
        procUnitConfObjA = project.addProcUnit(datatype='SpectraProc', inputId=voltage1.getId())
        procUnitConfObjA.addParameter(name='nFFTPoints', value=int(conf['usrp_tx']['repetitions_1'])/ncode, format='int')
        procUnitConfObjA.addParameter(name='nProfiles', value=int(conf['usrp_tx']['repetitions_1'])/ncode, format='int')


        #opObj11 = procUnitConfObjA.addOperation(name='setRadarFrequency')
        #opObj11.addParameter(name='frequency', value='9.345e9', format='float')
        #procUnitConfObjA.addOperation(name='removeDC')
        #if args.rmDC:
        #    op.addParameter(name='removeDC', value=1, format='int')

        proc1 = project.addProcUnit(datatype='ParametersProc', inputId=procUnitConfObjA.getId())
        proc1.addOperation(name='SpectralMoments')
    ...
    if '2' in args.pulses:
        ...
        procUnitConfObjB = project.addProcUnit(datatype='SpectraProc', inputId=voltage2.getId())
        procUnitConfObjB.addParameter(name='nFFTPoints', value=int(conf['usrp_tx']['repetitions_2'])/ncode, format='int')
        procUnitConfObjB.addParameter(name='nProfiles', value=int(conf['usrp_tx']['repetitions_2'])/ncode, format='int')

        
        
        #opObj11 = procUnitConfObjB.addOperation(name='setRadarFrequency')
        #opObj11.addParameter(name='frequency', value='9.345e9', format='float')
        #procUnitConfObjB.addOperation(name='removeDC')

        #if args.rmDC:
        #    op.addParameter(name='removeDC', value=1, format='int')

        proc2 = project.addProcUnit(datatype='ParametersProc', inputId=procUnitConfObjB.getId())
        proc2.addOperation(name='SpectralMoments')
